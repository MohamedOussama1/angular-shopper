...
export class ProductService {
  constructor() { }
  getAll() : Array<ProductItem>{
    return products
  }
  getById(id:number|undefined) : ProductItem | undefined{
    return products.filter(product => product.id == id).at(0);
  }
}
